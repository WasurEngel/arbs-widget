...
4. 分かりやすい名前（例：`Arbitration Overlay` など）を入力して「OK」を押します。
...
※背景を完全に消したり、文字色を自分好みに変更したい場合は、詳しい設定方法やプリセットコードをまとめた[CUSTOMIZE.md](CUSTOMIZE.md) をご覧ください。
...
本ツールのソースコードは [MIT License](LICENSE) のもとで公開されています。
